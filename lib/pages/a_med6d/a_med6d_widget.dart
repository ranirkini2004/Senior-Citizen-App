...
import 'a_med6d_model.dart';
export 'a_med6d_model.dart';

class AMed6dWidget extends StatefulWidget {
  const AMed6dWidget({super.key});

  static String routeName = 'AMed6d';
  static String routePath = '/aMed6d';

  @override
  State<AMed6dWidget> createState() => _AMed6dWidgetState();
}

class _AMed6dWidgetState extends State<AMed6dWidget> {
  late AMed6dModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AMed6dModel());
