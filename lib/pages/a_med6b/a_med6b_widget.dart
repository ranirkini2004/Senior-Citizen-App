...
import 'a_med6b_model.dart';
export 'a_med6b_model.dart';

class AMed6bWidget extends StatefulWidget {
  const AMed6bWidget({super.key});

  static String routeName = 'AMed6b';
  static String routePath = '/aMed6b';

  @override
  State<AMed6bWidget> createState() => _AMed6bWidgetState();
}

class _AMed6bWidgetState extends State<AMed6bWidget> {
  late AMed6bModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AMed6bModel());
