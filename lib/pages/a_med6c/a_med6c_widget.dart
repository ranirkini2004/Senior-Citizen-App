...
import 'a_med6c_model.dart';
export 'a_med6c_model.dart';

class AMed6cWidget extends StatefulWidget {
  const AMed6cWidget({super.key});

  static String routeName = 'AMed6c';
  static String routePath = '/aMed6c';

  @override
  State<AMed6cWidget> createState() => _AMed6cWidgetState();
}

class _AMed6cWidgetState extends State<AMed6cWidget> {
  late AMed6cModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AMed6cModel());
